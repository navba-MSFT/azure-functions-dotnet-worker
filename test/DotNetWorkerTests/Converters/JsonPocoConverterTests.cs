...
//            Assert.False(_jsonPocoConverter.TryConvertAsync(context, out object target));
...
//            Assert.True(_jsonPocoConverter.TryConvertAsync(context, out object bookObj));
...
//            Assert.True(_jsonPocoConverter.TryConvertAsync(context, out object target));
...
//            Assert.True(jsonPocoConverter.TryConvertAsync(context, out object bookObj));
